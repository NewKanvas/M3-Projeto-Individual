...
- `RESILIADATA.sql`: Contém o menu principal e a lógica de execução.
- `perguntas .txt`: Diretório com módulos utilitários.
- `Guia.txt`: Cores para melhorar a apresentação no console.
- `Sem título.png`: Funções para desenhar linhas decorativas.
